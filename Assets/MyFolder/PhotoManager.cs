...
public class PhotoManager : MonoBehaviour
{
    ...
    /// </summary>
    private UnityEngine.Windows.WebCam.PhotoCapture capture;
    ...
    public void StartCamera()
    {
        ...
        UnityEngine.Windows.WebCam.PhotoCapture.CreateAsync(ShowHolograms, OnPhotoCaptureCreated);
    }
    ...
    public void TakePhoto()
    {
        if (isReady)
        {
            ...
            capture.TakePhotoAsync(currentImagePath, UnityEngine.Windows.WebCam.PhotoCaptureFileOutputFormat.JPG, OnCapturedPhotoToDisk);
        }
        else
        {
    ...
    private void OnPhotoCaptureCreated(UnityEngine.Windows.WebCam.PhotoCapture captureObject)
    {
        ...
        Resolution resolution = UnityEngine.Windows.WebCam.PhotoCapture.SupportedResolutions.OrderByDescending(res => res.width * res.height).First();

        UnityEngine.Windows.WebCam.CameraParameters c = new UnityEngine.Windows.WebCam.CameraParameters(UnityEngine.Windows.WebCam.WebCamMode.PhotoMode);
