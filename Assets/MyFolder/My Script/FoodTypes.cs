...
public class FoodTypes : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        { "Bun bo Hue (Hue beef noodle soup)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        { "Bun cha (Grilled pork with vermicelli)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        { "Bun dau (Vermicelli with tofu)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        { "Bun mam (Fermented fish noodle soup)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        { "Bun rieu (Crab noodle soup)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        ...
        { "Mi Quang (Quang-style noodles)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
        ...
        { "Bun cha ca (Fish cake noodle soup)", new FoodItem("Pho (Vietnamese noodle soup)", "1 serving", new Nutrition(450, 15, 5, 3, 1.8f)) },
